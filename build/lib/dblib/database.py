...
# -*- coding: utf-8 -*-
"""
:Purpose:   This module contains the library's database methods and
            attribute accessors.
...
class DBInterface:
    ...
    Args:
        connstr (str): The database-specific connection string.
    ...
    def table_exists(self, table_name: str, verbose: bool=False) -> bool:
        ...
        with self.engine.connect() as conn:
            exists = bool(conn.execute(sa.text(stmt), params).fetchall()[0][0])
